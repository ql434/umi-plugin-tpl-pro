...
exports.default = function (api) {
  ...
  return class Generator extends api.Generator {
    writing() {
      ...
      var modelName = (0, _camelcase2.default)(name);
      ...
      var pageName = (0, _camelcase2.default)(modelName, { pascalCase: true });
      var serviceName = modelName.toLocaleLowerCase();
      ...
      this.fs.copyTpl((0, _path.join)(absTemplatePath, 'page.css'), (0, _path.join)(paths.absPagesPath, targetPagePath.join('/'), pageName + '.css'), {
        color: "red"
      });
      this.fs.copyTpl((0, _path.join)(absTemplatePath, 'model.js'), (0, _path.join)(paths.absPagesPath, 'models', modelName + '.js'), {
        name: modelName
      });
